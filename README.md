...
4. На некоторых браузерах нужно дополнительно включить разрешить пользовательские сценарии(юзерскрипты)
...
## Приколы и анимации
   - [rdb_warning](https://github.com/elchupacabr/totaldestroyer/raw/main/rgb_warning.user.js) ![Image](/rgb_warning.gif)
